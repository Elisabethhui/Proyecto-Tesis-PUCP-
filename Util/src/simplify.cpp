...
SymmetricMatrix::SymmetricMatrix(double c) {
    loopi(0,10) { m[i] = c;}
}

SymmetricMatrix::SymmetricMatrix(	double m11, double m12, double m13, double m14,
...
SymmetricMatrix::SymmetricMatrix(double a,double b,double c,double d)
{
...
double SymmetricMatrix::operator[](int c) const {
    return m[c];
}

// Determinant

double SymmetricMatrix:: det(	int a11, int a12, int a13,
...
const SymmetricMatrix SymmetricMatrix::operator+(const SymmetricMatrix& n) const
{
...
SymmetricMatrix& SymmetricMatrix::operator+=(const SymmetricMatrix& n)
{
