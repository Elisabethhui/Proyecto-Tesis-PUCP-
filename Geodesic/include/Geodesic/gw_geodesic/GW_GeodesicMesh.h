...
class GEODESIC_API GW_GeodesicMesh: public GW_Mesh
{
...
public:
    ...
    /*Setter information for algorithm (ADDED)*/
    void setStopInformation(GW_U32* ep, GW_U32 n, GW_Float d);
    GW_Bool checkStopCriterion(GW_GeodesicVertex& Vert);

    void setInsertionConstraint(GW_Float* dist, GW_U32 n);
    GW_Bool checkInsertionConstraint(GW_GeodesicVertex& Vert, GW_Float rNewDist);

    void setWeights(GW_Float* w);
	...
	static GW_Float BasicWeightCallback(GW_GeodesicVertex& Vert);
...
protected:
    ...
    /** Input to control the algorithm*/
    GW_Float* H;
    GW_Float* W;
    GW_Float* L;
    GW_Float dmax;

    GW_Bool stopCriterion;
    GW_U32* end_points;
    GW_U32 nend;

    GW_Bool vertexInsertionCriterion;
    GW_U32 nbr_iter;
    GW_U32 niter_max;
