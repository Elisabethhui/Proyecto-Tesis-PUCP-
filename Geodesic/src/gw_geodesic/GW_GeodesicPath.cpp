/*------------------------------------------------------------------------------*/
/** 
 *  \file   GW_GeodesicPath.cpp
 *  \brief  Definition of class \c GW_GeodesicPath
...
#ifdef GW_SCCSID
    static const char* sccsid = "@(#) GW_GeodesicPath.cpp(c) Gabriel Peyré2003";
#endif // GW_SCCSID
...
#include "Geodesic/gw_geodesic/GW_GeodesicPath.h"
    ...
    #include "Geodesic/gw_geodesic/GW_GeodesicPath.inl"
#endif
