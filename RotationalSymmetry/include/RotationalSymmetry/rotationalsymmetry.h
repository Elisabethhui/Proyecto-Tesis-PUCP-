...
class ROTATIONALSYMMETRY_API RotationalSymmetry : public QThread {
...
public:
    RotationalSymmetry(QObject* parent=0);
    ~RotationalSymmetry();

    void setData(Harris3D::Mesh* in, Util::PropertySet* p){ input = in; prop = p;}
