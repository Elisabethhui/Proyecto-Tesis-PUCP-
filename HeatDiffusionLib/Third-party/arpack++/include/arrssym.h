...
inline void ARrcSymStdEig<ARFLOAT>::Aupp()
{
  ...
  // F77NAME(dsaupd)(&this->ido, &this->bmat, &this->n, this->which.c_str(), &this->nev, &this->tol, this->resid, &this->ncv,
  //                &this->V[1], &this->n, &this->iparam[1], &this->ipntr[1], &this->workd[1], &this->workl[1],
  //                &lworkl, &info);
} // Aupp.
...
inline void ARrcSymStdEig<ARFLOAT>::Eupp()
{
  ...
  irvec   = (ARint) this->rvec;
  iselect = new ARlogical[this->ncv];
  iZ = (this->EigVec == NULL) ? &this->V[1] : this->EigVec;

  F77NAME(dseupd)(&irvec, &this->HowMny, iselect, this->EigValR, iZ, &this->n, &this->sigmaR, &this->bmat,
                  &this->n, this->which.c_str(), &this->nev, &this->tol, this->resid, &this->ncv, &this->V[1], &this->n, &this->iparam[1],
                  &this->ipntr[1], &this->workd[1], &this->workl[1], &this->lworkl, &this->info );
...
{
	//cout << "ARrcSymStdEig::EigeValVectors" << endl;
  ...
  //cout << "Fin ARrcSymStdEig::EigeValVectors" << endl;
  return this->nconv;
