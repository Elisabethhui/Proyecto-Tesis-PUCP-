#ifndef __BIHARMONIC_DISTANCE_H__
#define __BIHARMONIC_DISTANCE_H__
...
namespace HeatDiffusion{
    namespace Distance{
        ...
        //! Compute the Biharmonic distance between vertices in a 3D mesh
        class HEATDIFFUSION_API BiharmonicDistance{
            protected:
                float* evals;
                float* evecs;
             ...
             public:
                ...
                */
                BiharmonicDistance(float* eval, float* evec, unsigned int nV, unsigned int nE);
